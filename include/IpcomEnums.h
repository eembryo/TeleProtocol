...
static const char *OpContextStatusString[] = {
...
/***
 * OPCONTEXT_TRIGGER - 1 byte data
 * if most significant bit is 1, the trigger is a final event before removing operation context
 * -----------------
 * |f|b|b|b|b|b|b|b|
 * -----------------
 *
...
typedef enum {
	...
	OPCONTEXT_TRIGGER_FINALIZE = 0x80,
	OPCONTEXT_TRIGGER_FINALIZE_UNKNOWN_FAILED,
	OPCONTEXT_TRIGGER_FINALIZE_WFA_EXPIRED,
	OPCONTEXT_TRIGGER_FINALIZE_WFR_EXPIRED,
	OPCONTEXT_TRIGGER_FINALIZE_TRANSMIT_FAILED,
} IpcomProtocolOpContextTriggers;

static const char *OpContextTriggerString[] = {
		"",
		"OPCONTEXT_TRIGGER_SEND_REQUEST",
		"OPCONTEXT_TRIGGER_SEND_RESPONSE",
		"OPCONTEXT_TRIGGER_RECV_REQUEST",
		"OPCONTEXT_TRIGGER_RECV_RESPONSE",
		"OPCONTEXT_TRIGGER_RECV_ACK",
