...
#define TRANSPORT_LOCAL_ADDRESS "198.18.50.1"
#define TRANSPORT_LOCAL_PORT 50000
#define TRANSPORT_ALLOW_BROADCAST FALSE

#define TRANSPORT2_LOCAL_ADDRESS "198.18.50.1"
#define TRANSPORT2_LOCAL_PORT 50002
#define TRANSPORT2_ALOW_BROADCAST FALSE

#define SERVER_SERVICE_ID	0x00A1
#define SERVER_NOTIFICATION_OPERATION_ID 0x0107

#define SUBSCRIBER_UDP_ADDRESS "198.18.50.97"
#define SUBSCRIBER_UDP_PORT 50000

#define SUBSCRIBER2_UDP_ADDRESS "198.18.32.1"
#define SUBSCRIBER2_UDP_PORT 50002
...
gint main(gint argc, gchar *argv[])
{
	...
	gint	client_id;
	gint	transport_id, transport2_id;
	...
	transport2_id = IpcmdAgentTransportAddUdpv4Server (agent, TRANSPORT2_LOCAL_ADDRESS, TRANSPORT2_LOCAL_PORT);

	IpcmdAgentTransportAddUdpv4ManualChannel (agent, transport2_id, TRANSPORT2_LOCAL_ADDRESS, TRANSPORT2_LOCAL_PORT, SUBSCRIBER2_UDP_ADDRESS, SUBSCRIBER2_UDP_PORT);
	...
	IpcmdAgentServerAddNotiSubscriberUdpv4 (agent,
			...
			SERVER_NOTIFICATION_OPERATION_ID, //operation id
			TRUE,	//NOTIFICATION_CYCLIC ?
			SUBSCRIBER2_UDP_ADDRESS,			//address of subscriber
			SUBSCRIBER2_UDP_PORT,			//port of subscriber
			TRUE	//is the subscriber static ?
			);
